...
//±Í ∂ «∑Ò∆Ù”√TCP ±º‰¥¡—°œÓ°£ƒ¨»œ÷µŒ™1(true)°£
// ±º‰¥¡ø…“‘ π¡¨Ω”µƒ¡Ω∂À∫‹∑Ω±„µƒ≤‚¡øRTT£¨Õ¨ ±ªπø…“‘±‹√‚–Ú∫≈µƒªÿ»∆£¨“Ú¥ÀŒ™¡À µœ÷∏¸∫√µƒ–‘ƒ‹”¶∏√∆Ù”√∏√—°œÓ°£≤Œº˚RFC1323
int sysctl_tcp_timestamps __read_mostly = 1;
//±Í ∂ «∑Ò∆Ù”√TCP¥∞ø⁄¿©¥Û“Ú◊”—°œÓ°£ƒ¨»œ÷µŒ™1(true)°£
//Õ®≥£«Èøˆœ¬TCP‘ –Ì¥∞ø⁄≥ﬂ¥ÁŒ™65535B£¨µ´∂‘”⁄¥¯øÌ∫‹∏ﬂµƒÕ¯¬Á∂¯—‘’‚∏ˆ÷µø…ƒ‹ªπ «Ã´–°£¨¥À ±»Áπ˚∆Ù”√¡À∏√—°œÓ£¨ø… πTCPª¨∂Ø¥∞ø⁄
//¥Û–°‘ˆ¥Û ˝∏ˆ ˝¡øº∂£¨¥”∂¯Ã·π© ˝æ›¥´ ‰µƒƒ‹¡¶£¨≤Œº˚RFC1323
int sysctl_tcp_window_scaling __read_mostly = 1;
//±Í ∂ «∑Ò∆Ù”√—°‘Ò–‘»∑»œSACKS—°œÓ°£ƒ¨»œ÷µŒ™1(true)°£
//SACKø…“‘”√¿¥≤È’“Ãÿ∂®µƒ∂™ ßµƒ∂Œ£¨“Ú¥À”–÷˙”⁄øÏÀŸª÷∏¥◊¥Ã¨°£Õ¨ ±£¨∆Ù”√SACK£¨Ω” ’∑Ωø…“‘”–—°‘Òµÿ”¶¥¬“–ÚΩ” ’µΩµƒ∂Œ£¨
//ø…∞Ô÷˙∑¢ÀÕ∑Ω»∑∂®∂™ ßµƒ∂Œ£¨Ω¯∂¯∑¢ÀÕ∑Ω÷ª–Ë∑¢ÀÕ∂™ ßµƒ∂Œ£¨“‘Ã·∏ﬂ–‘ƒ‹°£
//∂‘”⁄π„”ÚÕ¯Õ®–≈¿¥Àµ”¶∏√∆Ù”√∏√—°œÓ£¨µ´ «’‚ª·‘ˆº”CPUµƒ∏∫∫…£¨≤Œº˚RFC2018

int sysctl_tcp_sack __read_mostly = 1;
//±Í÷æ «∑Ò∆Ù”√FACK”µ»˚±‹√‚”ÎøÏÀŸ÷ÿ¥´π¶ƒ‹°£
//◊¢“‚£¨÷ª”–µ±∆Ù”√sysctl_tcp_sack ±£¨∏√œµÕ≥≤Œ ˝≤≈”––ß
int sysctl_tcp_fack __read_mostly = 1;
//‘⁄≤ª÷ß≥÷SACK ±£¨Œ™”…”⁄¡¨Ω”Ω” ’µΩ÷ÿ∏¥»∑»œ∂¯Ω¯»ÎøÏÀŸªÿ∏¥Ω◊∂Œµƒ÷ÿ∏¥»∑»œ ˝„–÷µ°£
//‘⁄÷ß≥÷SACK ±£¨‘⁄√ª”–»∑∂®∂™ ß∞¸µƒ«Èøˆœ¬£¨ «TCP¡˜÷–ø…“‘÷ÿ≈≈µƒ ˝æ›∂Œ ˝°£
//ƒ¨»œ÷µŒ™3(∏ˆ)°£»Áπ˚ΩµµÕ¥À÷µ£¨ø…ƒ‹ª·µº÷¬Õ¯¬Á–‘ƒ‹±‰≤Ó°£
int sysctl_tcp_reordering __read_mostly = TCP_FASTRETRANS_THRESH;
//±Í ∂ «∑Ò∆Ù”√TCPµƒœ‘ æ”µ»˚Õ®÷™π¶ƒ‹°£
int sysctl_tcp_ecn __read_mostly;
//±Í ∂ «∑Ò÷ß≥÷TCP∑¢ÀÕ»∑»œ∂Œ÷–SACK—°œÓ¥Ê‘⁄D-SACK(duplicate-SACK)°£
int sysctl_tcp_dsack __read_mostly = 1;
//Œ™”¶”√≥Ã–Ú±£¡Ùmax(window/2^sysctl_tcp_app_win, mss)¥Û–°µƒ¥∞ø⁄°£µ±Œ™0 ±±Ì æ≤ª–Ë“™ª∫≥Â°£ƒ¨»œ÷µŒ™31
int sysctl_tcp_app_win __read_mostly = 31;
//‘⁄ø™∆Ù¡ÀÕ®π˝µ˜Ω⁄Ω” ’¥∞ø⁄¿¥Ω¯––¡˜¡øøÿ÷∆µƒ«Èøˆœ¬£¨º∆À„µ˜’˚Ω” ’ª∫¥Ê∫ÕΩ” ’¥∞ø⁄ ±£¨
//∂‘”√¿¥º∆À„Ω” ’ª∫¥Êµƒ≤Œ ˝Ω¯––Œ¢µ˜°£ƒ¨»œ÷µŒ™2°£
//À„∑®≤Œº˚tcp_win_from_space(int space)£¨∆‰≤Œ ˝spaceæÕ «Ω´±ªŒ¢µ˜µƒ≤Œ ˝
int sysctl_tcp_adv_win_scale __read_mostly = 2;
int sysctl_tcp_stdurg __read_mostly;
int sysctl_tcp_rfc1337 __read_mostly;
int sysctl_tcp_max_orphans __read_mostly = NR_FILE;
//±Í ∂ «∑Ò∆Ù”√F-RTO
//∆Ù”√F-RTO£¨ª·∆Ù”√”≈ªØ∫ÛµƒTCP÷ÿ¥´À„∑®°£’‚‘⁄Œﬁœﬂª∑æ≥÷–Ãÿ±”––ß£¨
//“ÚŒ™Õ®≥£ «”…”⁄ŒﬁœﬂµÁ∏…»≈∂¯≤ª «”…”⁄¬∑”…∆˜”µ»˚µº÷¬ÀÊª˙∂™∞¸
int sysctl_tcp_frto __read_mostly = 2;
int sysctl_tcp_frto_response __read_mostly;
int sysctl_tcp_nometrics_save __read_mostly;
//±Í æ «∑Ò∆Ù∂Ø◊‘∂Øµ˜Ω⁄Ω” ‹ª∫≥Â«¯¥Û–°°£ƒ¨»œ÷µŒ™1(true)
//»Áπ˚∆Ù”√£¨TCPª·◊‘∂Øµÿµ˜’˚Ω” ’ª∫≥Â«¯µƒ¥Û–°£¨“‘¥À¿¥Ω¯––¡˜¡øøÿ÷∆£¨‘⁄¬˙◊„ª∫≥Â«¯¥Û–°≤ªƒ‹≥¨π˝œµÕ≥≤Œ ˝sysctl_tcp_rmem[2](high)µƒÃıº˛œ¬£¨Ã·π©◊Ó¥ÛµƒÕÃÕ¬¡ø
int sysctl_tcp_moderate_rcvbuf __read_mostly = 1;
//±Í ∂ «∑Ò∆Ù”√ABC°£
// 0(ƒ¨»œ÷µ) -- Ω˚”√ABC£¨√ø¥Œ ’µΩACK∂ºª·‘ˆ≥§”µ»˚¥∞ø⁄
// 1		   -- ¿€º∆»∑»œ¡À“ª∏ˆ»´≥ﬂ¥Áµƒ∂Œ÷Æ∫Û≤≈ª·µ›‘ˆ”µ»˚¥∞ø⁄
// 2         -- »Áπ˚Ω” ’∑Ω∆Ù”√¡À—” ±»∑»œ£¨¿€º∆»∑»œ¡À¡Ω∏ˆ»´≥ﬂ¥Áµƒ∂Œ÷Æ∫Û≤≈ª·µ›‘ˆ”µ»˚¥∞ø⁄
//ABC∂®“Â‘⁄RFC3465÷–£¨ «∏˘æ›Ω” ’µΩµƒACK»∑»œµƒ◊÷Ω⁄ ˝¿¥øÿ÷∆”µ»˚¥∞ø⁄‘ˆ≥§µƒ“ª÷÷∑Ω∑®
...
static int __tcp_grow_window(const struct sock *sk, const struct sk_buff *skb)
{
	...
	int window = tcp_win_from_space(sysctl_tcp_rmem[2])/2; //Ω” ’ª∫≥Â«¯≥§∂»…œœﬁµƒ“ª∞Î

	//rcv_ssthresh≤ª≥¨π˝“ª∞ÎµƒΩ” ’ª∫≥Â«¯…œœﬁ≤≈”–ø…ƒ‹
...
static void tcp_grow_window(struct sock *sk, struct sk_buff *skb)
{
	...
	/* Check #1 */
	if (tp->rcv_ssthresh < tp->window_clamp 			//Ω” ’¥∞ø⁄µ±«∞„–÷µ≤ªƒ‹≥¨π˝Ω” ’¥∞ø⁄µƒ…œœﬁ
		&& (int)tp->rcv_ssthresh < tcp_space(sk) 		//Ω” ’¥∞ø⁄µ±«∞„–÷µ≤ªƒ‹≥¨π˝ £”‡Ω” ’ª∫¥Êµƒ3/4£¨º¥network buffer
		&& !tcp_memory_pressure)						//√ª”–ƒ⁄¥Ê—π¡¶
	{
		int incr;
		...
		//∏˘æ›∂ÓÕ‚ø™œ˙µƒƒ⁄¥Ê’ºµƒ±»÷ÿ£¨¿¥≈–∂œ «∑Ò‘ –Ì‘ˆ≥§°£∂ÓÕ‚µƒƒ⁄¥Êø™œ˙(overhead)÷∏µƒ «£∫
		//sk_buff°¢skb_shared_infoΩ·ππÃÂ£¨“‘º∞–≠“ÈÕ∑°£”––ßµƒƒ⁄¥Êø™œ˙÷∏µƒ « ˝æ›∂Œµƒ≥§∂»°£
		//£®1£©∂ÓÕ‚ø™œ˙–°”⁄25%£¨‘Úrcv_ssthresh‘ˆ≥§¡Ω∏ˆ±æ∂À◊Ó¥ÛΩ” ’MSS°£
		//£®2£©∂ÓÕ‚ø™œ˙¥Û”⁄25%£¨∑÷Œ™¡Ω÷÷«Èøˆ°£
		
		 //»Áπ˚”¶”√≤„ ˝æ›’º’‚∏ˆskb◊‹π≤œ˚∫ƒƒ⁄¥Êµƒ75%“‘…œ£¨‘ÚÀµ√˜’‚∏ˆ ˝æ›±® «¥Ûµƒ ˝æ›±®£¨ 
         //ƒ⁄¥Êµƒ∂ÓÕ‚ø™œ˙Ωœ–°°£’‚—˘“ª¿¥Œ“√«ø…“‘∑≈–ƒµƒ‘ˆ≥§rcv_ssthresh¡À°£ 
		if (tcp_win_from_space(skb->truesize) <= skb->len)
			incr = 2*tp->advmss;	//‘ˆº”¡Ω∏ˆ±æ∂À◊Ó¥ÛΩ” ’MSS
		else
			incr = __tcp_grow_window(sk, skb);  // ø…ƒ‹‘ˆ¥Ûrcv_ssthresh£¨“≤ø…ƒ‹≤ª‘ˆ¥Û£¨æﬂÃÂ ”∂ÓÕ‚ƒ⁄¥Êø™œ˙∫Õ £”‡ª∫¥Ê∂¯∂®

		if (incr)
		{
			tp->rcv_ssthresh = min(tp->rcv_ssthresh + incr, tp->window_clamp);
			inet_csk(sk)->icsk_ack.quick |= 1;  //‘ –ÌøÏÀŸACK
		}
	}
}
...
static void tcp_event_data_recv(struct sock *sk, struct sk_buff *skb)
{
	...
	// √ø¥ŒΩ” ’µΩ¿¥◊‘∂‘∑Ωµƒ“ª∏ˆTCP ˝æ›±®£¨«“ ˝æ›±®≥§∂»¥Û”⁄128◊÷Ω⁄ ±£¨Œ“√«–Ë“™µ˜”√tcp_grow_window£¨‘ˆº”rcv_ssthreshµƒ÷µ£¨
	//“ª∞„√ø¥ŒŒ™rcv_ssthresh‘ˆ≥§¡Ω±∂µƒmss£¨‘ˆº”µƒÃıº˛ «rcv_ssthresh–°”⁄window_clamp,≤¢«“ rcv_ssthresh–°”⁄Ω” ’ª∫¥Ê £”‡ø’º‰µƒ3/4£¨
	//Õ¨ ±tcp_memory_pressure√ª”–±ª÷√Œª(º¥Ω” ’ª∫¥Ê÷–µƒ ˝æ›¡ø√ª”–Ã´¥Û)°£ tcp_grow_window÷–∂‘–¬ ’µΩµƒskbµƒ≥§∂»ªπ”–“ª–©œﬁ÷∆£¨≤¢≤ª◊‹ «‘ˆ≥§rcv_ssthreshµƒ÷µ*/ 
	if (skb->len >= 128)
 ...
 */
//Ω¯»ÎLoss◊¥Ã¨£¨ «∑Ò«Â≥˝SACK±Í÷æ»°æˆ”⁄how£¨how≤ªŒ™0‘Ú«Â≥˝ 
void tcp_enter_loss(struct sock *sk, int how)
{
	...
	tcp_for_write_queue(skb, sk)
	{
		...
		//»Áπ˚howŒ™1,‘ÚÀµ√˜≤ªπ‹sack∂Œ£¨¥À ±±Íº«À˘”–µƒ∂ŒŒ™∂™ ß
...
static void tcp_rearm_rto(struct sock *sk)
{
	...
	///Œ™0Àµ√˜À˘”–µƒ¥´ ‰µƒ∂Œ∂º“—æ≠acked°£¥À ±remove∂® ±∆˜°£∑Ò‘Ú÷ÿ∆Ù∂® ±∆˜°£
	if (!tp->packets_out)
	{
...
static int tcp_ack(struct sock *sk, struct sk_buff *skb, int flag)
{
	struct inet_connection_sock *icsk = inet_csk(sk);
	struct tcp_sock *tp = tcp_sk(sk);
	u32 prior_snd_una = tp->snd_una;		/* ¥ÀACK÷Æ«∞µƒsnd_una */  	
	u32 ack_seq = TCP_SKB_CB(skb)->seq;		/* ¥ÀACKµƒø™ º–Ú∫≈ */
	u32 ack = TCP_SKB_CB(skb)->ack_seq;		/* ¥ÀACKµƒ»∑»œ–Ú∫≈ */ 
	u32 prior_in_flight;
	u32 prior_fackets;
	s32 seq_rtt;
	int prior_packets;
	...
	//// «∑Ò…Ë÷√tcp_abc£¨”–…Ë÷√µƒª∞£¨Àµ√˜Œ“√«≤ª–Ë“™√ø∏ˆack»∑»œ∂º“™”µ»˚±‹√‚£¨“Ú¥ÀŒ“√«–Ë“™º∆À„“—æ≠ack(»∑»œ)µƒ◊÷Ω⁄ ˝°£
	//  /* tcp_abc—°œÓ¥¶¿Ì£¨¿€º”’‚∏ˆACK»∑»œµƒ◊÷Ω⁄ ˝ */
	if (sysctl_tcp_abc) 
	{
		if (icsk->icsk_ca_state < TCP_CA_CWR)
	...
	if (!(flag & FLAG_SLOWPATH) && after(ack, prior_snd_una))
	{
		 ...
		 */
		tcp_update_wl(tp, ack, ack_seq);  ///*º«¬º∏¸–¬∑¢ÀÕ¥∞ø⁄µƒACK∂Œ–Ú∫≈*
		tp->snd_una = ack;					//∏¸–¬∑¢ÀÕ¥∞ø⁄◊Û∂À
		flag |= FLAG_WIN_UPDATE;			//…Ë÷√∑¢ÀÕ¥∞ø⁄∏¸–¬±Í÷æ

		tcp_ca_event(sk, CA_EVENT_FAST_ACK);	//øÏÀŸ¬∑æ∂”µ»˚ ¬º˛π≥◊”
	...
	else  /* Ω¯»Î¬˝ÀŸ¬∑æ∂ */  
	{
		...
		flag |= tcp_ack_update_window(sk, skb, ack, ack_seq);  // /* ∏¸–¬∑¢ÀÕ¥∞ø⁄*/  

		/* ∏˘æ›SACK—°œÓ±Í÷æ÷ÿ¥´∂”¡–÷–SKBµƒº«∑÷≈∆◊¥Ã¨*/  
		if (TCP_SKB_CB(skb)->sacked)  
			flag |= tcp_sacktag_write_queue(sk, skb, prior_snd_una);

		/* ≤Èø¥ACK «∑Ò–Ø¥¯ECE±Í÷æ */
		//ø¥ø¥ «∑Ò ’µΩ¡Àœ‘ æ”µ»˚Õ®÷™£∫
		if (TCP_ECN_rcv_ecn_echo(tp, tcp_hdr(skb)))   //¬∑”…∆˜Õ®÷™∂™∞¸£¨÷√…œeceŒª
			flag |= FLAG_ECE;

		tcp_ca_event(sk, CA_EVENT_SLOW_ACK);  		 /* ¬˝ÀŸ¬∑æ∂”µ»˚ ¬º˛π≥◊”*/  
	}
	...
	if (!prior_packets)				/*ºÏ≤È «∑Ò”–∑¢ÀÕ«“Œ¥»∑»œµƒ∂Œ*/  
		goto no_queue;				/* ≥÷–¯∂® ±∆˜¥¶¿Ì*/  
	...
	/* ¥¶”⁄FRTO¥¶¿Ì÷–£¨frto_counterµƒ»°÷µŒ™1ªÚ2*/  
	if (tp->frto_counter)
		frto_cwnd = tcp_process_frto(sk, flag);		/* ≈–∂œRTO «∑ÒŒ™’Êµƒ*/  
	/* Guarantee sacktag reordering detection against wrap-arounds */
	if (before(tp->frto_highmark, tp->snd_una))
		tp->frto_highmark = 0;

	 /* »Áπ˚ACK «÷ÿ∏¥µƒ°¢ªÚ’ﬂ¥¯”–SACK—°œÓ°¢ªÚ’ﬂ≤ª «OpenÃ¨*/  
	if (tcp_ack_is_dubious(sk, flag)) 
	{
		 /* »Áπ˚¥ÀACK «ø…“…µƒ*/  
		  /* ø…“… «÷∏“—æ≠¥¶”⁄”µ»˚◊¥Ã¨£¨ªÚ∏’ ’µΩ”µ»˚–≈∫≈°£ 
         * ‘⁄’‚÷÷Ãıº˛œ¬»Áπ˚œÎΩ¯––”µ»˚±‹√‚£¨±ÿ–Î∑˚∫œ£∫ 
         * 1. ¥ÀACK»∑»œ¡À–¬µƒ ˝æ› 
         * 2. ≤ªƒ‹¥¶”⁄FRTO◊¥Ã¨ 
         * 3. ¥¶”⁄DisorderªÚLoss◊¥Ã¨ 
          */  
		...
		if ((flag & FLAG_DATA_ACKED) && !frto_cwnd && tcp_may_raise_cwnd(sk, flag))
			tcp_cong_avoid(sk, ack, prior_in_flight, 0);  /* ”µ»˚¥∞ø⁄µƒµ˜Ω⁄*/ 
		 /* ’‚¿ÔΩ¯»ÎTCPµƒ”µ»˚◊¥Ã¨ª˙£¨¥¶¿Ìœ‡πÿ”µ»˚◊¥Ã¨*/  
		tcp_fastretrans_alert(sk, prior_packets - tp->packets_out, flag);
	}
	else 
	{	/* ÷¡…ŸÀµ√˜ACK‘⁄OpenÃ¨*/  
	 /* ACK≤ª «ø…“…µƒ£¨»Áπ˚ACK»∑»œ¡À–¬µƒ ˝æ›£¨«“≤ª «frto£¨‘ÚΩ¯––”µ»˚±‹√‚*/  
	
		if ((flag & FLAG_DATA_ACKED) && !frto_cwnd)
			tcp_cong_avoid(sk, ack, prior_in_flight, 1);
	}

	/* »Áπ˚ACK»∑»œ¡À–¬µƒ∂Œ(–¬µƒ ˝æ›∂Œ°¢SYN∂Œ°¢SACK∂Œ£¨ªÚ’ﬂΩ” ’µΩµƒACK≤ª «÷ÿ∏¥µƒ£¨ 
     * ‘Ú»∑»œ∏√¥´ ‰øÿ÷∆øÈµƒ ‰≥ˆ¬∑”…ª∫¥ÊœÓ «”––ßµƒ°£ 
     */  
	if ((flag & FLAG_FORWARD_PROGRESS) || !(flag&FLAG_NOT_DUP))
...
no_queue:
	 ...
	 */
	if (tcp_send_head(sk))  /* »Áπ˚”– ˝æ›“™∑¢ÀÕ*/  
		tcp_ack_probe(sk); 	/* ≥÷–¯∂® ±∆˜¥¶¿Ì*/  
	return 1;

old_ack:
	/* »Áπ˚¥ÀACK“—æ≠»∑»œπ˝£¨«“¥¯”–SACK—°œÓµƒ–≈œ¢*/  
	if (TCP_SKB_CB(skb)->sacked)
		/* ÷ÿ–¬±Í÷æ∏˜∏ˆ∂Œµƒº«∑÷≈∆*/  
...
static void __tcp_ack_snd_check(struct sock *sk, int ofo_possible)
{
	...
	if (((tp->rcv_nxt - tp->rcv_wup) > inet_csk(sk)->icsk_ack.rcv_mss  //»Áπ˚Ω” ’µΩ¡À¥Û”⁄“ª∏ˆµƒ±®Œƒ£¨ƒ«√¥æÕ∑¢ÀÕack£¨“ªœ¬◊”»∑»œ¡Ω∏ˆ±®Œƒ
	     /* ... and right edge of window advances far enough.
	      * (tcp_recvmsg() will send ACK otherwise). Or...
	      */
	     && __tcp_select_window(sk) >= tp->rcv_wnd) ||					//–Ë“™µ˜’˚¥∞ø⁄£¨◊Ó¥ÛªØÕÃÕ¬¡ø
	    /* We ACK each frame or... */
	    tcp_in_quickack_mode(sk) ||
	    /* We have out of order data. */
	    (ofo_possible && skb_peek(&tp->out_of_order_queue)))  			// ’µΩ¬“–Úµƒ∞¸
	{
		/* Then ack it now */
		tcp_send_ack(sk);
	}
