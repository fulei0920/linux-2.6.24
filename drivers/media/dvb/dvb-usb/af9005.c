...
static int af9005_i2c_read(struct dvb_usb_device *d, u8 i2caddr, u8 reg, u8 * data, int len)
{
	int ret, i;
	u8 temp;
...
static int af9005_i2c_xfer(struct i2c_adapter *adap, struct i2c_msg msg[], int num)
{
