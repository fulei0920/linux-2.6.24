...
{
	return bus ? container_of(kset_get(&bus->subsys), struct bus_type, subsys) : NULL;
}
 ...
 */
//自动探测设备，如果嫩巩固找到适当的驱动程序，则将设备添加到bus->klist_devices
...
int bus_register(struct bus_type * bus)
{
	...
	//总线需要连接相关设备及其驱动程序的所有有关信息，
	//因此总线对二者注册了kset。两个kset分别是drivers和devices，都将总线作为父结点
